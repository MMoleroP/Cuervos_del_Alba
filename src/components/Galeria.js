    ...
    return (
      <>
        ...
        <p class="img-intro">Para que os vayan sonando nuestras caras, aquí hay una selección de fotos de algunos de los eventos a los que hemos enviado a nuestras fuerzas:</p>
            ...
            <h3 className="img-evento ms-auto">Reinos Enfrentados IX
          ...
          <h3 className="img-evento ms-auto">Reinos Enfrentados VIII
              <div class="img-container">
          ...
          <h3 className="img-evento ms-auto">Unión 2023
              <div class="img-container">
          ...
          <h3 className="img-evento ms-auto">Fuel Wars 2023
              <div class="img-container">
          ...
          <h3 className="img-evento ms-auto">Reinos Enfrentados VII
              <div class="img-container">
          ...
          <h3 className="img-evento ms-auto">Omnia. La ruina de Val'Sacer
              <div class="img-container">
          ...
          <h3 className="img-evento ms-auto">Reinos Enfrentados VI
              <div class="img-container">
          ...
          <h3 className="img-evento ms-auto">Unión 2022
              <div class="img-container">
                  <im
